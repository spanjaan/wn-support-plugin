...
/**
 * Class Upload
 * @package SpAnjaan\Upload\Components
 */
class Upload extends ComponentBase
{
    ...
    public function defineProperties()
    {
        return [
            'uploadPath' => [
                'title'       => 'spanjaan.support::lang.settings.upload_path',
                'description' => 'spanjaan.support::lang.settings.upload_path_description',
                'default'     => '',
                'type'        => 'string',
            ],
        ];
    ...
    public function onRender()
    {
        if (isset($_FILES['file']) && !empty($_FILES['file'])) {
            ...
            $result = [
                'status'   => 1,
                'message'  => trans('spanjaan.support::lang.message.success'),
                'fileName' => $fileName,
                'filePath' => $filePath,
                'checkImg' => 0,
            ];
