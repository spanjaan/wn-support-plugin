...
class TicketCategories extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('SpAnjaan.Support', 'support', 'ticketcategories');
    }
    ...
    public function index_onDelete()
    {
        if (($checkedIds = post('checked')) && is_array($checkedIds) && count($checkedIds)) {
            ...
            Flash::success(Lang::get('spanjaan.support::lang.ticketcategories.delete_selected_success'));
        } else {
            Flash::error(Lang::get('spanjaan.support::lang.ticketcategories.delete_selected_empty'));
        }
