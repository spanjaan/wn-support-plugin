...
class TicketComments extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('SpAnjaan.Support', 'support', 'ticketcomments');
    }
    ...
    public function index_onDelete()
    {
        if (($checkedIds = post('checked')) && is_array($checkedIds) && count($checkedIds)) {
            ...
            Flash::success(Lang::get('spanjaan.support::lang.ticketcomments.delete_selected_success'));
        } else {
            Flash::error(Lang::get('spanjaan.support::lang.ticketcomments.delete_selected_empty'));
        }
